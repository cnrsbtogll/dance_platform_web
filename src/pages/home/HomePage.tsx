...
function HomePage({ isAuthenticated, user }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="container mx-auto pt-16 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <Link
              to="/partners"
              className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 border border-transparent hover:border-red-100 dark:hover:border-red-900"
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Partner Bul</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">Dans partnerinizi bulun ve birlikte dans etmeye başlayın.</p>
            ...
            <Link
              to="/festivals"
              className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 border border-transparent hover:border-amber-100 dark:hover:border-amber-900"
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Festivaller</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">Dans festivallerini keşfedin ve unutulmaz deneyimler yaşayın.</p>
            ...
            <Link
              to="/nights"
              className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 border border-transparent hover:border-teal-100 dark:hover:border-teal-900"
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Dans Geceleri</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">Özel dans gecelerinde eğlenceye katılın ve dans edin.</p>
      ...
      {/* Instructors Section */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gray-50 dark:bg-gray-900">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Öne Çıkan Eğitmenler</h2>
        ...
        {loading ? (
          ...
          <div className="text-center py-8 bg-gray-100 dark:bg-gray-800 rounded-lg">
            <p className="text-gray-500 dark:text-gray-400">Henüz eğitmen bulunmuyor.</p>
          </div>
        ) : (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Öne Çıkan Dans Kursları</h2>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-10">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-brand-pink"></div>
            <span className="ml-3 text-gray-600 dark:text-gray-400">Dans kursları yükleniyor...</span>
          </div>
        ) : classes.length === 0 ? (
          <div className="text-center py-8 bg-gray-100 dark:bg-gray-800 rounded-lg">
            <p className="text-gray-500 dark:text-gray-400">Henüz dans kursu bulunmuyor.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {classes.map((danceClass) => (
              <Link
                ...
                className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-1">{danceClass.name}</h3>
                  <p className="text-brand-pink font-medium mb-2">{danceClass.danceStyle || 'Çeşitli'}</p>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-700 dark:text-gray-300 font-bold">{danceClass.price || '?'} {danceClass.currency || 'TRY'}</span>
                    <span className="text-gray-500 dark:text-gray-400 text-sm">{danceClass.duration || 60} dk</span>
                  </div>
                </div>
              </Link>
            ))}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gray-50 dark:bg-gray-900">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Öne Çıkan Dans Okulları</h2>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-10">
            <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-brand-pink"></div>
            <span className="ml-3 text-gray-600 dark:text-gray-400">Dans okulları yükleniyor...</span>
          </div>
        ) : schools.length === 0 ? (
          <div className="text-center py-8 bg-gray-100 dark:bg-gray-800 rounded-lg">
            <p className="text-gray-500 dark:text-gray-400">Henüz dans okulu bulunmuyor.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {schools.map((school) => (
