      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2">Dans Okulları</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="mb-8">
          <div className="flex justify-end">
            <select
              ...
              className="block w-48 px-3 py-2 text-base border-gray-300 dark:border-slate-600 focus:outline-none focus:ring-brand-pink focus:border-brand-pink sm:text-sm rounded-md"
            >
        ...
        {!loading && !error && schools.length === 0 && (
          <div className="text-center py-12 bg-gray-50 dark:bg-slate-900 rounded-lg">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">Dans Okulu Bulunamadı</h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Henüz sistemde kayıtlı dans okulu bulunmuyor.</p>
          </div>
        )}
      </div>
    </div>
