    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold">
          <span className="block bg-gradient-to-r from-brand-pink to-rose-600 bg-clip-text text-transparent leading-tight">Dans Geceleri</span>
        ...
        <div className="mt-8 flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 justify-center">
          <div className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-rose-600 hover:bg-purple-700">
