            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-red-100 dark:border-red-900/30 p-6">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                  Hesabınızı kalıcı olarak silmek istiyorsanız aşağıdaki butonu kullanın. Bu işlem geri alınamaz.
                </p>
                <button
                  id="delete-student-account-btn"
                  type="button"
                  onClick={() => setShowDeleteModal(true)}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800/50 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all cursor-pointer"
                >
